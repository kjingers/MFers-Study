 ...
 */
function getMockVerseText(verseNumber: number, translation: Translation): string {
  ...
  return mockTexts[translation] ?? `[${translation} v${verseNumber}] Mock verse text placeholder.`
}
